...
**[Download the installer (v0.2.0, ~1.3 MB)](installer/Usage%20Widget%20for%20Claude_0.2.0_x64-setup.exe)** — Windows 10 / 11 x64, no admin rights needed. (On Windows 10, the installer auto-installs the WebView2 runtime if it's missing — Windows 11 always has it.)
